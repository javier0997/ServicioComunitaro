...
export const EstudianteCreacion = () => {
  ...
  const onSubmit = async (data) => {
    try {
      setIsLoading(true);
      const doc = db.collection("estudiantes").doc();
      const estudiantes = {
        Nombre: data.Nombre,
      ...
      console.log(error);
      alert("Error! No se pudo crear un Estudiante!");
      setIsLoading(false);
    }
  };
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">{"Crear un Estudiante"}</DialogTitle>
        <DialogContent>
