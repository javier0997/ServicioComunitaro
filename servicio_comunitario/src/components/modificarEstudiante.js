...
export const ModificarEstudiante = (props) => {
  ...
  const onSubmit = async (data) => {
    try {
      setIsLoading(true);
      const usuarioupdate = db.collection("estudiantes");
      ...
      alert("Estudiante modificado con Exito!");
    } catch (error) {
      console.log(error);
      alert("Error! No se pudo modificar al Estudiante!");
      setIsLoading(false);
    }
  };
